...
def tictactoe(win, player1, player2):
    ...
    win.fill((0, 0, 0))
    ply1=Font1.render(player1[0].upper(), True, (0,0,0))
    ply2=Font1.render(player2[0].upper(),True, blue)
